...
grep -q 'recover_stale_runs' "$ROOT/framwork/tec_tac/scheduler.py"
grep -q 'cleanup_run_history' "$ROOT/framwork/tec_tac/scheduler.py"
grep -q 'MISSED_LATE_TOLERANCE = timedelta(minutes=3)' "$ROOT/framwork/tec_tac/scheduler.py"
...
grep -q '0013_scheduler_durability' <(find "$ROOT/framwork/tec_tac/migrations" -maxdepth 1 -type f -printf '%f\n')
grep -q 'ForceDeleted' "$ROOT/framwork/tec_tac/scheduler_views.py"
